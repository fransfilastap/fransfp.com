...
const FFPCard = ({ title, description, image, children }: Props) => {
    ...
    return (
        <motion.div initial="hidden" variants={variants} animate={isVisible ? 'visible':'hidden' } className="w-full p-4 rounded-3xl bg-lime-500 min-h-[15rem] flex flex-col items-start justify-end">
