...
const PostItem = ({ post }: PostItemProps) => {
    return (
        <div className={`px-2 cursor-pointer flex flex-col md:flex-row md:items-center md:justify-start md:space-x-10 w-full space-y-[0.1rem] py-10 ${styles['post-item']} group`}>
            <div className="hidden md:items-center md:w-1/6 md:h-full md:flex">
            ...
            <svg className="transition duration-150 ease-in-out opacity-0 group-hover:opacity-100 h-28 w-28" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
